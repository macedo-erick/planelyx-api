...
public class CreditCardService {
    ...
    public CreditCardService(CreditCardRepository creditCardRepository, BankAccountService bankAccountService) {
    ...
    public CreditCard findById(UUID id, UUID ownerId) {
        return creditCardRepository.findByIdAndOwnerId(id, ownerId)
